...
{{--                </div>--}}
                ...
                <h4>Useful Links</h4>
                <ul>
                <li><i class="ion-ios-arrow-right"></i> <a href="/terms-and-conditions">Terms and Conditions</a></li>
                ...
                <h4>Contact Us</h4>
                <p>
                    311/1, Rajasinghapura,<br>
                    Muruthalawa,<br>
                    Kandy, Sri Lanka.<br>
                <strong>Phone:</strong> +94 771 121 195<br>
                <strong>Email:</strong> admin@salfade.com<br>
                </p>
