...
<section id="services" style="margin-top: 5%">
    <div class="container">
        <h2>Welcome to Salfade</h2>
        <p>These terms and conditions outline the rules and regulations for the use of Salfade's Website.</p> <br/>
        <span style="text-transform: capitalize;"> Salfade</span> is located at:<br/>
        <address>311/1, Rajasinghapura, Muruthalawa Kandy <br/>20232 - Central , Sri Lanka<br/>
        </address>
        ...
        <p>The following terminology applies to these Terms and Conditions, Privacy Statement and Disclaimer Notice
            ...
            of Sri Lanka. Any use of the above terminology or other words in the singular, plural,
            capitalisation and/or he/she or they, are taken as interchangeable and therefore as referring to same.</p>
        <h2>Cookies</h2>
        <p>We employ the use of cookies. By using Salfade's website you consent to the use of cookies
            in accordance with Salfade's privacy policy.</p>
        <p>Most of the modern day interactive web sites
            use cookies to enable us to retrieve user details for each visit. Cookies are used in some areas of our site
            to enable the functionality of this area and ease of use for those people visiting. Some of our
            affiliate / advertising partners may also use cookies.</p>
        <h2>License</h2>
        <p>Unless otherwise stated, Salfade and/or it's licensors own the intellectual property rights for
            all material on Salfade. All intellectual property rights are reserved. You may view and/or print
            pages from https://salfade.com for your own personal use subject to restrictions set in these terms and
            conditions.</p>
        <p>You must not:</p>
        <ol>
            <li>Republish material from https://salfade.com</li>
            <li>Sell, rent or sub-license material from https://salfade.com</li>
            <li>Reproduce, duplicate or copy material from https://salfade.com</li>
        </ol>
        <p>Redistribute content from Salfade (unless content is specifically made for redistribution).</p>
        <h2>User Comments</h2>
        <ol>
            <li>This Agreement shall begin on the date hereof.</li>
            <li>Certain parts of this website offer the opportunity for users to post and exchange opinions,
                information,
                material and data ('Comments') in areas of the website. Salfade does not screen, edit, publish
                or review Comments prior to their appearance on the website and Comments do not reflect the views or
                opinions ofSalfade, its agents or affiliates. Comments reflect the view and opinion of the
                person who posts such view or opinion. To the extent permitted by applicable laws Salfadeshall
            ...
            <li>Salfadereserves the right to monitor all Comments and to remove any Comments which it considers
            ...
            <li>You hereby grant to <strong>Salfade</strong> a non-exclusive royalty-free license to use, reproduce,
        ...
        <p>We will approve link requests from these organizations if we determine that: (a) the link would not reflect
            ...
            the visibility associated with the hyperlink outweighs the absence of Salfade; and (d) where the
        ...
        <p>If you are among the organizations listed in paragraph 2 above and are interested in linking to our website,
            you must notify us by sending an e-mail to <a href="mailto:admin@salfade.com"
                                                          title="send an email to admin@salfade.com">admin@salfade.com</a>.
        ...
        <p>No use of Salfade's logo or other artwork will be allowed for linking absent a trademark license
            agreement.</p>
        <h2>Iframes</h2>
